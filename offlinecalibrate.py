...
def takepicture():
    img = cv2.imread('yellow.jpg', cv2.IMREAD_RGB)
    return img
...
def main():
    ...
    while(True):
        ...
        if colourindex == 0:
            ...
            img = cv2.imread("green.jpg", cv2.IMREAD_COLOR)
        elif colourindex == 3:
            img = cv2.imread("blue.jpg", cv2.IMREAD_COLOR)
        ...
        for cnt in contours:
            ...
            if (area > 100):
                ...
                # we could use cv2.minEnclosingCircle()
